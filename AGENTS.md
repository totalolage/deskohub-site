...
- Do not replace implementation-detail suffixes such as `Effect` or `Object` with a generic `Program` suffix. When two operations need distinct names, name their domain roles or behaviors.
