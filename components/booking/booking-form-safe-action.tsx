...
import { submitBookingSafeAction } from "@/app/actions/booking";
...
export function BookingFormSafeAction() {
  ...
  useEffect(() => {
    if (result?.data?.success) {
      toast.success(result.data.message || "Booking submitted successfully!");
