...
export type DiscountGroup = { readonly "discountPercent": string | null }
export const DiscountGroup = Schema.Struct({ "discountPercent": Schema.Union([Schema.String, Schema.Null]).annotate({ "description": "Percentage discount represented as a decimal string" }) })
