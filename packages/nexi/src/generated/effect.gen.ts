...
export type Operation = { readonly "orderId"?: string, readonly "operationId"?: string, readonly "operationType"?: "AUTHORIZATION" | "CAPTURE" | "VOID" | "REFUND" | "CANCEL", readonly "operationResult"?: "AUTHORIZED" | "PENDING" | "EXECUTED" | "DECLINED" | "DENIED_BY_RISK" | "DENIED" | "THREEDS_FAILED" | "FAILED" | "CANCELED" | "VOIDED" | "REFUNDED", readonly "amount"?: Amount, readonly "operationAmount"?: string, readonly "operationCurrency"?: string, readonly "securityToken"?: string, readonly "operationTime"?: string }
export const Operation = Schema.Struct({ "orderId": Schema.optionalKey(Schema.String), "operationId": Schema.optionalKey(Schema.String), "operationType": Schema.optionalKey(Schema.Literals(["AUTHORIZATION", "CAPTURE", "VOID", "REFUND", "CANCEL"])), "operationResult": Schema.optionalKey(Schema.Literals(["AUTHORIZED", "PENDING", "EXECUTED", "DECLINED", "DENIED_BY_RISK", "DENIED", "THREEDS_FAILED", "FAILED", "CANCELED", "VOIDED", "REFUNDED"])), "amount": Schema.optionalKey(Amount), "operationAmount": Schema.optionalKey(Schema.String.check(Schema.isPattern(new RegExp("^[0-9]+$")))), "operationCurrency": Schema.optionalKey(Schema.String.check(Schema.isMinLength(3)).check(Schema.isMaxLength(3))), "securityToken": Schema.optionalKey(Schema.String), "operationTime": Schema.optionalKey(Schema.String) })
...
export type OrderStatus = { readonly "authorizedAmount"?: string, readonly "capturedAmount"?: string, readonly "lastOperationTime"?: string, readonly "lastOperationType"?: "AUTHORIZATION" | "CAPTURE" | "VOID" | "REFUND" | "CANCEL", readonly "order": OrderStatusOrder }
export const OrderStatus = Schema.Struct({ "authorizedAmount": Schema.optionalKey(Schema.String), "capturedAmount": Schema.optionalKey(Schema.String), "lastOperationTime": Schema.optionalKey(Schema.String), "lastOperationType": Schema.optionalKey(Schema.Literals(["AUTHORIZATION", "CAPTURE", "VOID", "REFUND", "CANCEL"])), "order": OrderStatusOrder })
