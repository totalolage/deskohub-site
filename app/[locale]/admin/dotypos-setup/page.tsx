...
export default function DotyposSetupPage() {
  ...
  const [tokens, setTokens] = useState<{ refreshToken: string; cloudId: string } | null>(null);
  ...
  const generateAuthUrl = () => {
    ...
    const url = `https://admin.dotykacka.cz/client/connect?` +
  ...
  const envContent = tokens ? `# Dotypos API Configuration
          ...
          {!tokens ? (
            <>
              ...
              <div className="space-y-4">
                <h3 className="text-lg font-semibold">Step 1: Enter API Credentials</h3>
                <Alert>
                  <AlertCircle className="h-4 w-4" />
                  <AlertDescription>
                    You should have received these credentials from Dotypos after registering your application.
                ...
                <div className="space-y-2">
                  <Label htmlFor="redirectUri">Redirect URI (auto-filled)</Label>
                  <Input
                    id="redirectUri"
                    type="text"
                    value={redirectUri}
              ...
              {authUrl && (
                <div className="space-y-4 pt-4 border-t">
                  <h3 className="text-lg font-semibold">Step 2: Authorize Application</h3>
                  <Alert>
                    <AlertDescription>
                      Click the button below to open the Dotypos authorization page. 
                      Log in with your Dotypos account and grant access to your application.
                      You'll be redirected back here with the tokens.
                    </AlertDescription>
                  </Alert>
            ...
            <>
              {/* Step 3: Save Tokens */}
              <div className="space-y-4">
                <h3 className="text-lg font-semibold">Step 3: Save Your Tokens</h3>
                <Alert className="border-green-200 bg-green-50">
                  <CheckCircle2 className="h-4 w-4 text-green-600" />
                  <AlertDescription className="text-green-800">
                    Success! Authorization completed. Save these values to your .env.local file.
                  </AlertDescription>
                </Alert>
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex gap-2">
                    ...
                    >
                      {copied === 'refresh' ? <CheckCircle2 className="h-4 w-4" /> : <Copy className="h-4 w-4" />}
                    </Button>
                  </div>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex gap-2">
                    ...
                    >
                      {copied === 'cloud' ? <CheckCircle2 className="h-4 w-4" /> : <Copy className="h-4 w-4" />}
                    </Button>
                  </div>
                </div>
                ...
                <Alert>
                  <AlertCircle className="h-4 w-4" />
                  <AlertDescription>
                    <strong>Important:</strong> Add these values to your .env.local file (not .env) to keep them secure. 
