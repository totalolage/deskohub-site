...
export class MenuService extends Effect.Service<MenuService>()("MenuService", {
  effect: Effect.gen(function* () {
    ...
    return {
      /**
       * Generates props for rendering the menu.
       * This funciton must be ran server-side as it accesses Dotypos API.
       */
      getMenuProps: () =>
        Effect.gen(function* () {
  ...
  }).pipe(Effect.annotateLogs("service", "MenuService")),
