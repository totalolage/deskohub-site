 ...
 * Create customers
 */
export const createCustomers = <ThrowOnError extends boolean = false>(
  options: Options<CreateCustomersData, ThrowOnError>
) => {
  return (options.client ?? _heyApiClient).post<
    CreateCustomersResponses,
    CreateCustomersErrors,
...
export const getTables = <ThrowOnError extends boolean = false>(
  options: Options<GetTablesData, ThrowOnError>
) => {
  return (options.client ?? _heyApiClient).get<
    GetTablesResponses,
    GetTablesErrors,
