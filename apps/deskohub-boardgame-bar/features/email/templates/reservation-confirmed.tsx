...
const infoLines = (isEnglish: boolean) =>
  isEnglish
    ? [
    ...
    <html lang={locale}>
      ...
      >
        ...
        >
          ...
          >
            <h2 style={{ color: "#16a34a", marginTop: 0 }}>
              {isEnglish
              ...
              <tbody>
                ...
                {data.specialRequests ? (
                  <tr>
                    ...
                    <td style={{ padding: "10px 0", whiteSpace: "pre-wrap" }}>
                      {data.specialRequests}
                    </td>
                  </tr>
                ) : null}
          ...
          >
            <p style={{ margin: 0, color: "#166534" }}>
              <strong>
                {isEnglish ? "Important Information:" : "Důležité informace:"}
              </strong>
              {infoLines(isEnglish).map((line) => (
                <span key={line}>
                  <br />• {line}
                </span>
              ))}
          ...
          {data.confirmationUrl ? (
            <div style={{ textAlign: "center", margin: "30px 0" }}>
              <a
                href={data.confirmationUrl.toString()}
                style={{
          ...
          <p style={{ fontSize: "16px", marginTop: "30px" }}>
            {isEnglish ? "See you soon!" : "Brzy na viděnou!"}
            <br />
