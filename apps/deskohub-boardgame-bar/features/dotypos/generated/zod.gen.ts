...
export const zCreateReservationRequest = z.object({
    ...
    _employeeId: z.optional(z.string().register(z.globalRegistry, {
...
export const zReservation = z.object({
    ...
    _customerId: z.optional(z.string().register(z.globalRegistry, {
...
export const zCustomer = z.object({
    ...
    _discountGroupId: z.optional(z.union([
        z.string(),
        z.null()
    ])),
    _sellerId: z.optional(z.union([
        z.string(),
        z.null()
    ])),
...
export const zPaginatedCustomers = zPaginationBase.and(z.object({
...
export const zTable = z.object({
    ...
    _branchId: z.optional(z.string().register(z.globalRegistry, {
        description: 'Branch ID (long as string)'
    })),
    _cloudId: z.string().register(z.globalRegistry, {
        description: 'Cloud ID (long as string)'
    ...
    locationName: z.optional(z.string().register(z.globalRegistry, {
        description: 'Location name'
    })),
    positionX: z.optional(z.string().register(z.globalRegistry, {
        description: 'X position (string representation)'
    })),
    positionY: z.optional(z.string().register(z.globalRegistry, {
        description: 'Y position (string representation)'
    })),
    rotation: z.optional(z.string().register(z.globalRegistry, {
...
export const zPaginatedTables = zPaginationBase.and(z.object({
    data: z.optional(z.array(zTable).register(z.globalRegistry, {
...
export const zProduct = z.object({
    ...
    alternativeName: z.optional(z.union([
        z.string(),
        z.null()
    ])),
    ...
    packaging: z.optional(z.union([
        z.string(),
        z.null()
    ])),
    packageSize: z.optional(z.union([
        z.string(),
        z.null()
    ])),
    points: z.optional(z.union([
    ...
    priceWithVat: z.optional(z.union([
        z.string(),
        z.null()
    ])),
    ...
    printTicket: z.optional(z.union([
        z.boolean(),
        z.null()
    ])),
    stockDeduct: z.optional(z.union([
        z.boolean(),
        z.null()
    ])),
    ...
    unit: z.optional(z.string().register(z.globalRegistry, {
        description: 'Unit of measurement (actual values vary from documented enum)'
    })),
...
export const zPaginatedProducts = zPaginationBase.and(z.object({
    data: z.optional(z.array(zProduct).register(z.globalRegistry, {
...
export const zCategory = z.object({
    ...
    fiscalName: z.optional(z.union([
        z.string(),
        z.null()
    ])),
    ordering: z.optional(z.union([
        z.string(),
        z.null()
    ])),
    translatedName: z.optional(z.union([
...
export const zPaginatedCategories = zPaginationBase.and(z.object({
    data: z.optional(z.array(zCategory).register(z.globalRegistry, {
 ...
 */
export const zPageParam = z.int().register(z.globalRegistry, {
 ...
 */
export const zLimitParam = z.int().lte(100).register(z.globalRegistry, {
