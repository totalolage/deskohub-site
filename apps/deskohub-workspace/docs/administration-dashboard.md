...
The customer detail summary shows a full-width activity chart for the previous 365 complete Prague calendar dates. It counts ended Workspace-linked reservations once on their Dotypos start date and reports the chart as unavailable when those booking dates cannot be loaded.
