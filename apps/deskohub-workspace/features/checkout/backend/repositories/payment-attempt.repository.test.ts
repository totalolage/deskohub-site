...
const createReservationsTable = sql.raw(`
  create table workspace_reservations (
    ...
    checkout_attempt_identity_key text not null unique,
    checkout_session_compatibility_key text not null,
    checkout_attempt_compatibility_key text not null unique,
...
const reservationRow = (
  ...
  checkoutSessionIdentityKey: `session-identity-${id}`,
  checkoutAttemptIdentityKey: `attempt-identity-${id}`,
  checkoutSessionCompatibilityKey: `session-compatibility-${id}`,
  checkoutAttemptCompatibilityKey: `attempt-compatibility-${id}`,
