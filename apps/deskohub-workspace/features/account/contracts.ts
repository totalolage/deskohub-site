...
export const customerAccountIdSchema = Schema.NonEmptyString.pipe(
  Schema.brand("CustomerAccountId")
).annotate({
  identifier: "CustomerAccountId",
  description: "Opaque identifier assigned to a customer by Neon Auth.",
});
