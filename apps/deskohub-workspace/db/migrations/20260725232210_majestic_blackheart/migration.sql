...
SET
  ...
  "checkout_attempt_identity_key" = "checkout_attempt_key";--> statement-breakpoint
...
CREATE INDEX "workspace_reservations_checkout_session_identity_idx" ON "workspace_reservations" ("checkout_session_identity_key","created_at");
