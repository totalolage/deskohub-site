...
export const invoices = pgTable(
  ...
  (t) => [
    ...
    check(
      ...
      sql`(${t.paymentAttemptId} is null and ${t.orderId} is null and ${t.workspaceReservationId} is null) or (${t.paymentAttemptId} is not null and (${t.orderId} is not null or ${t.workspaceReservationId} is not null))`
    ),
