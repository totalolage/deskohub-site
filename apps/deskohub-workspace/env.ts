...
export const env = createEnv({
  ...
  runtimeEnv: {
    ...
    ADMIN_PREVIEW_FIXTURES: process.env.ADMIN_PREVIEW_FIXTURES,
    ...
    POSTHOG_HISTORY_HOST: process.env.POSTHOG_HISTORY_HOST,
    POSTHOG_HISTORY_PROJECT_ID: process.env.POSTHOG_HISTORY_PROJECT_ID,
