...
export const env = createEnv({
  ...
  runtimeEnv: {
    ...
    NEXI_CANCEL_URL_BASE: process.env.NEXI_CANCEL_URL_BASE,
    NEXI_CALLBACK_URL_BASE: process.env.NEXI_CALLBACK_URL_BASE,
    NEXI_ORIGIN: process.env.NEXI_ORIGIN,
    NEXI_RESULT_URL_BASE: process.env.NEXI_RESULT_URL_BASE,
