...
- Voucher creation instead stores positive issued credit on the code. Vouchers have no discount definition or use-count limit; expose issued and remaining credit rather than calling them unlimited.
